...
interview_router.route("/add").post(interview_controller.add);
interview_router.route("/get_all").get(interview_controller.get_all);
interview_router.route("/get/:interview_id").get(interview_controller.get_by_interview_id);
interview_router.route("/update/:interview_id").put(interview_controller.update);
interview_router.route("/delete/:interview_id").delete(interview_controller.delete_);
...
interview_router.route("/get_result/:user_id").get(interview_controller.get_by_user_id);
