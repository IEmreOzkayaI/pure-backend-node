...
interview_router.route("/register_user_to_interview/:interview_signature").post(upload.single("cover_letter"), extract_interview_token, interview_controller.register_user_to_interview);
...
interview_router.route("/get_result/:interview_signature").get(validate_access_token_handler, extract_interview_token, interview_controller.get_result_by_interview_signature);
